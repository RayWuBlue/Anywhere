...
public class NewsContent extends BaseActivity {
	...
	private void initToolbar() {
		addButton(item.getComment_num()+"",R.drawable.comment,new OnClickListener() {
			...
			public void onClick(View v) {
				Intent it = new Intent(NewsContent.this, ActFlashPlay.class);
		...
		addButton(R.drawable.intro_to_gay, new OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				AndroidShare as = new AndroidShare(NewsContent.this, "#"
						+ temmItem.getTitle() + "#"
	...
	private void Oncollect() {
		...
		if (!IsCollected) {
			try {
				...
				values.put("news_id", NewsContent.this.temmItem.getId());
				values.put("news_title", NewsContent.this.temmItem.getTitle());
				values.put("news_time", NewsContent.this.temmItem.getTime());
				...
				if (insert_result != -1) {
					IsCollected = true;
					T.show(NewsContent.this, "�ղسɹ�", Toast.LENGTH_SHORT);
					btnCollect.setImageResource(R.drawable.colllected);
				} else
					T.show(NewsContent.this, "�ղ�ʧ��", Toast.LENGTH_SHORT);
				System.out.println("��������" + insert_result);
			} catch (SQLException e) {
				T.show(NewsContent.this, "�ղ�ʧ�ܣ�����Ի�����Ϣ", Toast.LENGTH_SHORT);
				e.printStackTrace();
			}
		} else {
			T.show(NewsContent.this, "ȡ���ղ�", Toast.LENGTH_SHORT);
	...
	private void initcollect() {
		 ...
		 */
		DBUtil dbu = DBUtil.getInstance(NewsContent.this);
		int id = NewsContent.this.temmItem.getId();
