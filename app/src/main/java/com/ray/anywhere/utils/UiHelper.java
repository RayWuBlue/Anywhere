...
import com.ray.anywhere.bean.NewsBean;
...
public class UiHelper {
	...
	public static void redirect(Context context, NewsBean news) {
		...
		if("��������".equals(news.getColumn())){
			...
			mBundle.putSerializable("com.pw.schoolknow.ser",item);  
			
		}else if("У԰��Ѷ".equals(news.getColumn())){
