...
import com.ray.anywhere.activity.ImgPreview;
...
public class MyTagHandler implements TagHandler {
		...
		if (tag.toLowerCase().equals("at")) {
			if (opening) {
				...
				output.setSpan(new ForegroundColorSpan(Color.parseColor("#396CA4")),
						startIndex, stopIndex, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE); //ǰ��ɫ
	...
	//���»��߳����ӣ�ʹ��textColorLink��textColorHighlight�ֱ��޸ĳ�����ǰ��ɫ�Ͱ���ʱ����ɫ
	private class NoLineClickSpan extends ClickableSpan { 
	    ...
	    public void updateDrawState(TextPaint ds) {
	        ...
	        ds.setUnderlineText(false);//ȥ���»���</span>
	    }
