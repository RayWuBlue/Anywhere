...
import com.ray.anywhere.adapter.ScoreAdapter;
...
/*    private Spinner sp_year;
	...
	private void initView(){
		setTitle("我的成绩");
		addButton("查询设置",new OnClickListener() {
			...
			public void onClick(View v) {
				...
				popmenu.setOnItemClickListener(new MyPopMenuImp() {
					...
					public void onItemClick(int index) {
						...
						System.out.println("CURRENT_YEAR:"+currentYear+" CURRENT_TERM:"+currentTermId);
	...
	public class MyThread extends Thread{
		...
		public void run() {
			switch(statu){
			case 0:
				queryxq(c_year,c_term,"btXqcj",0);
				break;
			case 1://绩点查询
